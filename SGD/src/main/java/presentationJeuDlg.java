...
public class presentationJeuDlg extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(presentationJeuDlg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                presentationJeuDlg dialog = new presentationJeuDlg(new javax.swing.JFrame(), true,1,0);
